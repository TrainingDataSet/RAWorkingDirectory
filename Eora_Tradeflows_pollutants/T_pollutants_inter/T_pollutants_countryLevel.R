...
# exports_df <- read_csv("Eora_inter_exports_pair_FromIndustryToCountry/Eora_inter_exports.csv")
...
task <- function(year_lst) {
  ...
  for (year in year_lst) {
    ...
    write_csv(T_EachYear4, paste0("T_pollutants_countryLevel/T_pollutants_", 
