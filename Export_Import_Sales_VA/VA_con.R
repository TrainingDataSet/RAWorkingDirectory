...
gdp_deflator <- read_csv("USgdp_deflator_FRED.csv")
exports_imports_sales_va <- read_csv("Export_Import_Sales_VA/Export_Import_Sales_VA_EntireCountry.csv")
...
write_csv(exports_imports_sales_va3, "Export_Import_Sales_VA/Export_Import_Sales_VA_EntireCountry.csv")
