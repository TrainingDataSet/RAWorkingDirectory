...
# Run
df <- read_csv("OECD/Dataset/network_consideringOECD.csv")
df$Year <- as.numeric(as.character(df$Year))

variables <- c("LB_nonoecd", "LB_oecd", "LB_CO2_nonoecd", "LB_GHG_nonoecd", 
               "LB_CO2_oecd", "LB_GHG_oecd", "MB_nonoecd", "MB_oecd", 
               "MB_CO2_nonoecd", "MB_GHG_nonoecd", "MB_CO2_oecd", "MB_GHG_oecd", 
               "MB_network2nd_nonoecd", "LB_network2nd_nonoecd", 
               "MB_network2nd_oecd", "LB_network2nd_oecd", 
               "MB_network2nd_CO2_nonoecd", "MB_network2nd_GHG_nonoecd", 
               "LB_network2nd_CO2_nonoecd", "LB_network2nd_GHG_nonoecd", 
               "MB_network2nd_CO2_oecd", "MB_network2nd_GHG_oecd", 
               "LB_network2nd_CO2_oecd", "LB_network2nd_GHG_oecd"
)
file_name <- "OECD/Dataset/network_consideringOECD_tw.csv"
