...
# 2025-01-15: Exports of industry s of country i to foreign country j
...
cal_tradeness <- function(df, country_i, country_j) {
  ...
  export <- df[which(df$X2 == country_i), which(df[3, ] %in% country_j & df[3, ] != country_i)]
...
country_i <- "DZA"
country_j <- c("DZA", "AGO", "ARG", "AUS", "AUT", "AZE", "BHR", "BGD", "BLR", "BEL", "BOL", "BIH", "BRA", "BGR", "KHM", "CAN", "CHL", "CHN", "COL", "COG", "CRI",
