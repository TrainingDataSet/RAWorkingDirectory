...
dataset4 <- dataset3[, c("Forward_to_trade_i_mean", "Forward_to_trade_i_first")]

dataset5 <- read_parquet("Linkages/Linkages_to_tradedSector/Linkages_to_tradedSector_ij.parquet")
...
print(mean(dataset7$Forward_to_trade))  # 0.1016876
print(mean(dataset8$Forward_to_trade))  # 0.08959308
print(mean(dataset9$Forward_to_trade))  # 0.05131217
print(first(dataset7$Forward_to_trade))  # 0.06324436
print(first(dataset8$Forward_to_trade))  # 0.1300208
print(first(dataset9$Forward_to_trade))  # 0.05775072
