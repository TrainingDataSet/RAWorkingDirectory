...
# t_df <- read_csv("Eora_exports_pair_FromIndustryToCountry/Final_exports/Final_exports.csv")
...
task <- function(year_lst) {
  ...
  for (year in year_lst) {
    ...
    write_csv(BT_EachYear3, paste0("consideringNothing/BT_final/BT_", 
