...
# t_df <- read_csv("Eora_exports_pair_FromIndustryToCountry/Inter_exports/Inter_exports.csv")
...
task <- function(year_lst) {
  ...
  for (year in year_lst) {
    ...
    write_csv(BT_EachYear3, paste0("consideringNothing/BT_inter/BT_", 
