...
cal_cte <- function(df, t, country_i, country_j) {
...
# df <- read_csv("consideringNothing/RWC/RWC.csv")
# 
# country_i <- "AGO"
# country_j <- "ARG"
# t <- c(2010:2019)
# 
# print(cal_cte(df, t, country_i, country_j))
# 
...
for (t in c("1", "2", "3", "4")) {
  ...
  write_csv(Corr_df3, paste0("consideringNothing/Time_window/CTE_tw.csv"))
}
