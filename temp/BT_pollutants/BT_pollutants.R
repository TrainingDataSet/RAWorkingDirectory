...
# t_df <- read_csv("T_pollutants_sectorLevel/T_pollutants.csv")
...
task <- function(year_lst) {
  ...
  for (year in year_lst) {
    ...
    write_csv(BT_EachYear4, paste0("temp/BT_pollutants/BT_pollutants_", 
...
stopCluster(cl)
print(Sys.time()-time)  # --> running time 1:56:09